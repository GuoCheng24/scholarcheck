...
<sub>The figure above is generated by <a href="https://github.com/GuoCheng24/scholarcheck/blob/main/docs/three-states_figure.py">docs/three-states_figure.py</a> — <code>pip install sciglyph</code> and run it to reproduce <code>docs/three-states.png</code> byte by byte.</sub>
